...
app = Flask(__name__)
CORS(app, resources={r"/*": {"origins": ["https://ntok5eh8dg.execute-api.eu-south-2.amazonaws.com", "http://midiloadbalancer-33bc8d136623c566.elb.eu-south-2.amazonaws.com"]}})
